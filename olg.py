...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/nadia.sheikh.9277583)
	subprocess.check_output(["am", "start", "https://m.me/nadia.sheikh.9277583"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get(''https://github.com/Junaidkhan012/olg.git).text
			if basesplit in plr:
				key = basesplit
